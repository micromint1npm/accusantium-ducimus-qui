# @micromint1npm/accusantium-ducimus-qui

[![Build Status](https://secure.travis-ci.org/nathanboktae/@micromint1npm/accusantium-ducimus-qui.png)](http://travis-ci.org/nathanboktae/@micromint1npm/accusantium-ducimus-qui)

@micromint1npm/accusantium-ducimus-qui is an extension to the [chai](http://chaijs.com/) assertion library that
...
```
npm install @micromint1npm/accusantium-ducimus-qui
```

### bower

```
bower install @micromint1npm/accusantium-ducimus-qui
```
...
chai.use(require('@micromint1npm/accusantium-ducimus-qui'))
```

### AMD

```javascript
require(['chai', '@micromint1npm/accusantium-ducimus-qui'], function(chai, chaiDom) {
  chai.use(chaiDom)
})
```
...
<script src="@micromint1npm/accusantium-ducimus-qui.js"></script>
```
